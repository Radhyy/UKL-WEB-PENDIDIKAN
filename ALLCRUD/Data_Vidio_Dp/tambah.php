...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_materi = $conn->query("SELECT materi_id FROM video_dp WHERE materi_id='$materi_id'");
    ...
    // Simpan ke database
    $sql = "INSERT INTO video_dp (id, youtube_link, guru_nama, deskripsi, materi_id)
